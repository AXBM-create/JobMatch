  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 mb-8">
        ...
        {/* Right Action: Credits + Espace Client + New Application Button */}
        <div className="flex items-center gap-3">
          {userProfile && (
            <div
          ...
          <a
            href={getExternalClientPortalUrl(userProfile?.email)}
            target="_blank"
            rel="noopener noreferrer"
            id="btn-history-espace-client"
            className="hidden md:inline-flex items-center gap-1.5 px-3 py-2 bg-white hover:bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 transition-colors shadow-2xs"
            title="Gérer mon abonnement et mes factures sur mon espace client externe"
          >
